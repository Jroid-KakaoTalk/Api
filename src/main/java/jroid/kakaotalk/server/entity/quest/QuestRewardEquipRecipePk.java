...
import jroid.kakaotalk.server.entity.item.EquipRecipe;
import lombok.*;
...
public class QuestRewardEquipRecipePk implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof QuestRewardEquipRecipePk) {
            QuestRewardEquipRecipePk pk = (QuestRewardEquipRecipePk) obj;
